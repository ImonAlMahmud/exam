...
<body>
    <div class="dashboard-container">
        ...
        <aside class="sidebar" id="sidebar"> <!-- Added ID 'sidebar' -->
            ...
            <nav class="sidebar-nav">
                ...
                <a href="#" class="nav-item"><i class="fa-solid fa-chart-line"></i> <span>Leaderboards</span></a> <!-- This link will also need updating later -->
                <a href="<?php echo BASE_URL; ?>mentor/profile.php" class="nav-item <?php echo (basename($_SERVER['PHP_SELF']) == 'profile.php') ? 'active' : ''; ?> active"><i class="fa-solid fa-user"></i> <span>My Profile</span></a>
            </nav>
            ...
            <div class="profile-layout">
                ...
                <section class="content-panel profile-details-panel">
                    ...
                    <form id="profileForm">
                        ...
                        <!-- Mentor roles don't have roll_no or batch_name normally -->
    ...
    <script src="<?php echo BASE_URL; ?>assets/js/mentor_profile.js"></script>
</body>
</html>